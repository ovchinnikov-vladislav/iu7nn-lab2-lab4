...
public class BaggingLogisticRegressionML {

    public static void build(Dataset<Row> trainingData, Dataset<Row> testData) throws IOException {
        UtilFile.recursiveDeleteModel("datasets/model/bagging-logistic-regression-voice.model");
        ...
        BaggingClassifier classifier = new BaggingClassifier()
                ...
                .setBaseLearner(new LogisticRegression()) //Base learner used by the meta-estimator.
        ...
        TestModel.test(testData, model, "Bagging Logistic Regression Model");

        BaggingClassificationModel baggingClassificationModel =
                (BaggingClassificationModel) (model.stages()[1]);

        baggingClassificationModel.save("datasets/model/bagging-logistic-regression-voice.model");
    }
